...
class PaillierPublicKey(object):
    ...
    def raw_encrypt(self, plaintext,apha,r_value=None):
        ...
        """
        nude_ciphertext = (self.n * (plaintext._value + (apha*EncodedNumber.C_BASE)) + 1) % self.nsquare
    ...
    def encrypt_encoded(self, encoding, r_value):
        ...
        ciphertext = self.raw_encrypt(encoding.encoding,encoding.apha,r_value=obfuscator)
        ciphertext_base = ciphertext % EncodedNumber.C_BASE
        apha = ciphertext // EncodedNumber.C_BASE
